...
La fonction `query_I_SMOD_SERV_MD_CM_AG` est une `parent_function` qui retourne une syntaxe sql pour: <br/>
...
- la fonction [user_I_SMOD_SERV_MD_CM_AG](user_I_SMOD_SERV_MD_CM_AG.html) <br/>
...
```{r, eval=FALSE}
debut = "2021-04-01", fin = "2022-03-31"
```
