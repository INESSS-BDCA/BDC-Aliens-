...
1) extraire les variables pertinentes de SMOD combinées avec d'autres vues de données <br/>
...
```{r}
query="extraction_SMOD" # extraire les variables pertinentes de SMOD combinées avec d'autres vues de données pour rajouter les caractéristiques de bénéficiaire, dispensateur et l'établissement du soins. 
...
La fonction `query_I_SMOD_SERV_MD_CM_AG` est principalement utilisée par la fonction `user_I_SMOD_SERV_MD_CM_AG`. Voir [user_I_SMOD_SERV_MD_CM_AG](user_I_SMOD_SERV_MD_CM_AG.html)<br/>. Elle peut-être également exécutée indépendament des autres fonctions.   
