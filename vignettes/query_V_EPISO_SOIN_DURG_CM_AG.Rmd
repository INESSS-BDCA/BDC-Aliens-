...
1) extraire les variables pertinentes de BDCU `V_EPISO_SOIN_DURG_CM` combinées avec d'autres bases de données pour rajouter les caractéristiques du bénéficiaire et de l'établissement de soins. <br/>
2) extraire les variables pertinentes de la base de données BDCU `V_OCCU_CIVIE_DURG_CM`. <br/>
3) extraire les variables pertinentes de la base de données BDCU `V_CNSUL_DURG_CM`. <br/>
4) extraire les diagnostics pour la création d'une cohorte <br/>
...
```{r, eval=FALSE}
query_V_EPISO_SOIN_DURG_CM_AG(query,
                           debut_periode, 
                           fin_periode, 
                           diagn,
                           date_dx_var,
...
```{r}
query=c("extraction_BDCU_EPISO_SOIN_DURG","extraction_BDCU_OCCU_CIVIE_DURG","extraction_BDCU_CNSUL_DURG","extraction_Dx") 
...
query="extraction_BDCU_EPISO_SOIN_DURG",
debut_periode="2021-04-01",
fin_periode="2022-03-31",
diagn = NULL, #  à préciser si on veut extraire les variables BDCU pour des bénéficiaires ayant un ou plusieurs Dx spécifiques dans V_EPISO_SOIN_DURG_CM 
date_dx_var=c('admis', 'depar'),
...
WHERE SURG_DHD_EPISO_SOIN_DURG between '2021-04-01' and '2022-03-31'
AND SURG_COD_DIAGN_MDCAL_CLINQ like any ("2500%", "2501%", "2502%","E100%", "E101%", "E109%", "E110%", "E111%")
