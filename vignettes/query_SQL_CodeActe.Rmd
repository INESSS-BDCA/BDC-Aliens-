...
`query_SQL_CodeActe` est une fonction intermédiaire qui retourne une syntaxe sql, laquelle est utilisée par la fonction \code{\link{SQL_CodeActe}} afin d'extraire les actes entre une date de début et de fin d'une étude. Les caractéristiques du bénéficiaire ainsi que de l'établissement de soins sont également fournies.
