...
date: "Date de création: 01 janvier 2023"
output:
...
1) d'extraire les dates de visites avec les caractéristiques de bénéficiaire.<br/>
2) de calculer le nombre d'acte par bénéficiaire entre la date de début et de fin d'une étude avec les caractéristiques de bénéficiaire.<br/>
3) d'extraire les codes d'actes, avec les caractéristiques de bénéficiaire et de l'établissement de soins.<br/>
...
[SQL_reperage_cond_med](SQL_reperage_cond_med.html): pour la création de une cohorte de en utilisant les Dx cim-9 et/ou cim-10<br/> 
[query_I_SMOD_SERV_MD_CM_AG](query_I_SMOD_SERV_MD_CM_AG.html): 
  - si `task="date_visite"` extraction des dates de visites avec les caractéristiques de bénéficiaire<br/>
